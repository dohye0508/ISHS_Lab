...
if (!isset($_SESSION['user_id'])) {
    header("Location: auth.php?msg=login_required&redirect=integral.php");
    exit();
}
                        ...
                        <div class="selection-container">
                            ...
                            <div class="rules-section">
                                ...
                                <ul class="rules-list">
                                    ...
                                    <li>(중요) 간간히 초등함수로 적분불가능한 문제가 나옵니다. 이때는 <strong>적포</strong>(적분 포기)라고 쓰셔야 합니다. 마지막에
                                        띄어쓰기를 한번 누르셔야 한글 중복 버그를 막을 수 있습니다.</li>
                                </ul>
                            </div>
                        </div>
            ...
            <div id="quiz-area">
                ...
                <div class="action-bar">
                    ...
                    <div style="flex-grow: 1; text-align: center;">
                        <button id="btn-giveup" class="btn secondary hidden" onclick="giveUpProblem()">적포(적분
                            포기)</button>
                    </div>
